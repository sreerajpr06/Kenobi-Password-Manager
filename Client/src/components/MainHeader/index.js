            ...
            <nav class="flex items-center justify-between flex-wrap bg-darkgrey p-6">
                ...
                <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                    <div class="text-sm lg:flex-grow">
                        <Link
                            to="/team"
                            class="block mt-2 lg:inline-block lg:mt-2 text-white hover:text-orange font-light mr-4"
                        >
                            TEAM
                        </Link>
                    </div>
                    <div>
                        ...
                        <Link
                            to="/register"
                            class="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-orange hover:border-transparent bg-orange hover:text-teal mt-4 lg:mt-0"
                        >
                            REGISTER
                        </Link>
                    </div>
